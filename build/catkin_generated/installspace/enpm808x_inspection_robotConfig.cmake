...
if(enpm808x_inspection_robot_CONFIG_INCLUDED)
  return()
endif()
set(enpm808x_inspection_robot_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("FALSE" STREQUAL "TRUE")
  set(enpm808x_inspection_robot_SOURCE_PREFIX /home/charu/catkin_ws/src/enpm808x_inspection_robot)
  set(enpm808x_inspection_robot_DEVEL_PREFIX /home/charu/catkin_ws/src/enpm808x_inspection_robot/build/devel)
  set(enpm808x_inspection_robot_INSTALL_PREFIX "")
  set(enpm808x_inspection_robot_PREFIX ${enpm808x_inspection_robot_DEVEL_PREFIX})
else()
  set(enpm808x_inspection_robot_SOURCE_PREFIX "")
  set(enpm808x_inspection_robot_DEVEL_PREFIX "")
  set(enpm808x_inspection_robot_INSTALL_PREFIX /usr/local)
  set(enpm808x_inspection_robot_PREFIX ${enpm808x_inspection_robot_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'enpm808x_inspection_robot' is deprecated")
...
if(NOT "include;/usr/include;/usr/include/gazebo-9;/usr/include/bullet;/usr/include/simbody;/usr/include/sdformat-6.0;/usr/include/ignition/math4;/usr/include/OGRE;/usr/include/OGRE/Terrain;/usr/include/OGRE/Paging;/usr/include/ignition/transport4;/usr/include/ignition/msgs1;/usr/include/ignition/common1;/usr/include/ignition/fuel_tools1 " STREQUAL " ")
  ...
  elseif(NOT "http://wiki.ros.org/enpm808x_inspection_robot " STREQUAL " ")
    set(_report "Check the website 'http://wiki.ros.org/enpm808x_inspection_robot' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'diane <diane@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${enpm808x_inspection_robot_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'enpm808x_inspection_robot' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'enpm808x_inspection_robot' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
    _list_append_unique(enpm808x_inspection_robot_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND enpm808x_inspection_robot_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND enpm808x_inspection_robot_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT enpm808x_inspection_robot_NUM_DUMMY_TARGETS)
      set(enpm808x_inspection_robot_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::enpm808x_inspection_robot::wrapped-linker-option${enpm808x_inspection_robot_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR enpm808x_inspection_robot_NUM_DUMMY_TARGETS "${enpm808x_inspection_robot_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::enpm808x_inspection_robot::wrapped-linker-option${enpm808x_inspection_robot_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND enpm808x_inspection_robot_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /usr/local/lib;/home/charu/beginner_tutorials/devel/lib;/opt/ros/melodic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(enpm808x_inspection_robot_LIBRARY_DIRS ${lib_path})
      list(APPEND enpm808x_inspection_robot_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'enpm808x_inspection_robot'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND enpm808x_inspection_robot_LIBRARIES ${lib})
    endif()
  endif()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 enpm808x_inspection_robot_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${enpm808x_inspection_robot_dep}_FOUND)
      find_package(${enpm808x_inspection_robot_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${enpm808x_inspection_robot_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(enpm808x_inspection_robot_INCLUDE_DIRS ${${enpm808x_inspection_robot_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(enpm808x_inspection_robot_LIBRARIES ${enpm808x_inspection_robot_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${enpm808x_inspection_robot_dep}_LIBRARIES})
  _list_append_deduplicate(enpm808x_inspection_robot_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(enpm808x_inspection_robot_LIBRARIES ${enpm808x_inspection_robot_LIBRARIES})

  _list_append_unique(enpm808x_inspection_robot_LIBRARY_DIRS ${${enpm808x_inspection_robot_dep}_LIBRARY_DIRS})
